...
# Defina p1 e p2 globalmente
p1 = 0  # Substitua 0 pelo valor correto
p2 = 0  # Substitua 0 pelo valor correto
xs = []
ys = []
...
# Defina a função goal_track corretamente com p1 e p2 como argumentos
def goal_track(img, bbox, p1, p2):
...
# Você precisa definir 'video' e 'tracker' antes de entrar no loop
...
while True:
    ...
    goal_track(img, bbox, p1, p2)  # Passe p1 e p2 como argumentos
